...
--
-- Host: localhost
-- Czas generowania: 28 Lip 2018, 18:59
...
(113, '2018-07-27', '13:00:00', '15:00:00', 4, 'Czerwona'),
...
--
ALTER TABLE `rezerwacje`
  MODIFY `id_rezerwacji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT dla tabeli `sale`
--
ALTER TABLE `sale`
  MODIFY `id_sali` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
